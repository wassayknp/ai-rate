...
export default function ProductsScreen() {
  ...
  const handleCustomDateSelect = (startDate: string, endDate: string) => {
    setDateFilter(selectedDateType, 'custom', { startDate, endDate });
    showToast(`📅 Custom date range selected: ${startDate} to ${endDate}`, 'success', 'center');
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]} testID="products-screen">
      ...
      <CalendarPopup
        ...
        onSelectDateRange={handleCustomDateSelect}
      />
